...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{'Indi-Voidance', 'Indi-Poison', 'Indi-Precision'},
        Enhancing = T{'Protect', 'Shell', 'Barfira', 'Barthundra'},
        Ninjutsu = T{},
        Singing = T{'Dark Carol', 'Light Carol', 'Dark Carol II', 'Light Carol II'},
        Blue = T{},
        Summoning = T{'Carbuncle', 'Fenrir', 'Leviathan', 'Diabolos'}},
    save_settings = false
...
function precast(spell)
    ...
    if gs_skill.skillup_type == "Singing" then
        ...
        elseif (gs_skillup.test_mode and gs_skillup.test_brd == "String") or not gs_skillup.skill['Stringed Instrument Capped'] then
