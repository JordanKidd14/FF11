...
function get_sets()
	...
	Rosmerta = {}
	Rosmerta.Crit = { name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken-10%'} }
	Rosmerta.WSD = { name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken-10%'} }
	Rosmerta.STP = { name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken-10%'} }
	Rosmerta.DA = { name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken-10%'} }
	Rosmerta.DW = { name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken-10%'} }
	...
	sets.BlueMagic.Enmity = {  -- 51~
		ammo="Sapience Orb",  --2
		body="Emet Harness", --9
		hands="Nilas Gloves", --5
		feet="Ahosi Leggings",  --7
		neck="Warder's Charm +1", --7~
		waist="Chaac Belt",
		right_ear="Friomisi Earring",  --2
		left_ear="Cryptic Earring",
		left_ring="Petrov Ring",  --4
		right_ring="Supershear Ring", --5
		back={ name="Rosmerta's Cape", augments={'Enmity+10',}},  -- 10
	}
	...
	sets.JA.Diffusion = set_combine(sets.BlueMagic.Buffs, { feet={ name="Luhlaza Charuqs +1", augments={'Enhances "Diffusion" effect',}}, })
...
function maps()
	...
	PhysicalBlueMagic_DEX = S {
		...
		'Frenetic Rip', 'Goblin Rush', 'Hysteric Barrage', 'Seedspray', 'Vanity Dive'
	}
	...
	if spell.skill == 'Blue Magic' then
        ...
        if MagicalSpells:contains(spell.english) then
			...
			elseif BlueMagic_Dark:contains(spell.english) then
				msg("Spell dark based items -- equipped")
				ChangeGear(set_combine(sets.BlueMagic.INT.MAB,
					{
						head = "Pixie Hairpin +1",
