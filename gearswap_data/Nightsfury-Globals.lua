...
send_command('bind numpad2 send @others cure4 <me>; send Nightsfury /echo Self cure')
...
-- DEBUFFS
send_command('bind numpad8 send Nightsfury /echo RDM Debuffs; sat youcommand @rdm Frazzle3; wait 5; sat youcommand @rdm Distract3; wait 5; sat youcommand @rdm Paralyze2; wait 5; sat youcommand @rdm Slow2; wait 5; sat youcommand @rdm Addle2; wait 5; sat youcommand @rdm blind2;')
