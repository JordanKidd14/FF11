...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {
        main={ name="Espiritus", augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','Pet: Damage taken -4%',}}, --2  II
        sub="Vox Grip",
        ammo="Sancus sachet",  -- -6 II
        head="Con. Horn +1", -- -8 I
        body={ name="Glyphic Doublet", augments={'Reduces Sp. "Blood Pact" MP cost',}}, -- -1 II
        ...
        back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Accuracy+2 Pet: Rng. Acc.+2','Pet: Haste+10',}},
    }
    ...
    sets.midcast.Pet.BloodPactWard = {
        ...
        ammo="Sancus sachet",
        head="Con. Horn +1", --15
        body="Caller's Doublet +1", --7
        hands="Lamassu Mitts", --21
        legs="Beckoner's Spats", --15
        feet="Con. Pigaches +1",
        neck="Incanter's Torque", --10
        waist="Lucidity Sash", --7
        left_ear="Enmerkar Earring",
        right_ear="Lugalbanda Earring",
        left_ring="Fervor Ring", --4
        right_ring="Evoker's Ring", --10
        back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Accuracy+2 Pet: Rng. Acc.+2','Pet: Haste+10',}},
    }

    sets.midcast.Pet.DebuffBloodPactWard = set_combine(sets.midcast.Pet.BloodPactWard, {feet="Tali'ah Crackows +1"})
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {
        ...
        body="Con. Doublet +2",
        hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+21','Blood Pact Dmg.+8','Pet: AGI+7',}},
        legs={ name="Enticer's Pants", augments={'MP+50','Pet: Accuracy+15 Pet: Rng. Acc.+15','Pet: Mag. Acc.+15','Pet: Damage taken -5%',}},
        feet="Con. Pigaches +1",
        neck="Caller's Pendant",
        waist="Klouskap Sash",
    ...
    sets.resting = {
        main={ name="Gridarvor", augments={'Pet: Accuracy+70','Pet: Attack+70','Pet: "Dbl. Atk."+15',}},
        ammo="Sancus sachet",
        head="Con. Horn +1",neck="Wiglen Gorget",left_ear="Evans Earring",
    ...
    sets.idle.PDT = {
        sub="Elan Grip",ammo="Sancus sachet",
        head="Con. Horn +1",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe +1",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Sangoma Ring",
    ...
    sets.idle.PDT.Avatar = {
        sub="Elan Strap",ammo="Sancus sachet",
        head="Con. Horn +1",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Loquacious Earring",
